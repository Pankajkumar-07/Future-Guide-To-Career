    ...
    <main>
        <div class="card" style="width:100%; max-width:1255px; min-height:1000px; margin: 18px auto;">
            ...
            <div class="page-content">
                ...
                <h2 id="subtopics" class="section-title">Computer Programming Subtopics</h2>
                ...
                <h3 style="margin-top: 30px;">More Computer ProgrammingSubtopics</h3>
                <ul class="more-subtopics" style="columns: 2;">
                    <li>High-Performance Computing</li>
                    <li>Human-Computer Interaction (Computer Programming)</li>
                    <li>Microprocessors</li>
                    <li>VLSI Design (Very-Large-Scale Integration)</li>
                </ul>

                <h2 id="courses" class="section-title">Popular Computer Programming Courses</h2>
                ...
                <h3 style="margin-top: 30px;">Explore our full library of Computer Programming courses</h3>
                <ul class="more-subtopics" style="columns: 2;">
                ...
                <div class="lesson-grid">
                    ...
                    <div class="grid-item">
                        ...
                        <strong>Computer Programming: Lesson for Kids</strong>
                ...
                <h2 id="overview" class="section-title">What is Computer Programming?</h2>
