...
<head>
    ...
    <title>Future Guide To Career - Jobs</title>
  ...
  <div>
    ...
    <main>
        ...
        <div class="main-diagram-container">
            <img src="career_img/img1.4.png" alt="Career Center Diagram" class="Career-diagram-img">
        </div>
        <div class="slider">
             <p><h3>User:- <?= isset($_SESSION['user']) ? htmlspecialchars($_SESSION['user']['username']) : 'Guest' ?></h3></p>
            <h2> <center>Jobs Requirement </center></h2>
                  <p>This is the content section for Jobs resources.</p>
            </div>          
    </main>
