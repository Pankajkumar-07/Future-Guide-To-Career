...
<head>
    ...
    <title>Future Guide To Career - Culture </title>
  ...
  <div>
    ...
    <main>
        ...
        <div class="main-diagram-container">
            <img src="career_img/img1.5.png" alt="Career Center Diagram" class="Career-diagram-img">
        </div>
        <div class="slider">
             <p><h3>User:- <?= isset($_SESSION['user']) ? htmlspecialchars($_SESSION['user']['username']) : 'Guest' ?></h3></p>
            <h2> <center>Culture Activities</center></h2>
                  <p>This is the content section for culture resources.</p>
            </div>          
    </main>
